...
public class SeleniumTest {
    ...
    @Test
    @DisplayName("Comprobar que el boton 'Cancel' en la página de edit devuelve a la página del libro")
	public void cancelEditBookTest() throws Exception {
        ...
        String title = "FAKE BOOK TO DELETE";
        String description = "Contenido de prueba 3";

        this.createNewBook(title, description);

        // WHEN: Editamos el libro

        // Hacemos click en "New book"
        driver.findElement(By.xpath("//*[text()='Edit']")).click();
        
        driver.findElement(By.xpath("//*[text()='Cancel']")).click();
        // Navegamos a la página de todos los libros

        // THEN: Esperamos estar en la página del libro
        wait.until(ExpectedConditions.presenceOfElementLocated(By.id("bookDescription")));
    }
